...
public class MovieCatalogueRepository implements MovieCatalogueDataSource {
    ...
    private MovieCatalogueRepository(@NonNull RemoteDataSource remoteDataSource){
        this.remoteDataSource = remoteDataSource;
    }

    public static MovieCatalogueRepository getInstance(RemoteDataSource remoteDataSource){
        if(INSTANCE == null){
            synchronized (MovieCatalogueRepository.class){
                if(INSTANCE == null){
                    INSTANCE = new MovieCatalogueRepository(remoteDataSource);
                }
            }
        }
        return INSTANCE;
