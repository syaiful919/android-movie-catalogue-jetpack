...
public class DummyData {
    ...
    public static MovieEntity getSelectedMovie(String id) {
        ArrayList<MovieEntity> movies = generateDummyMovies();
    ...
    public static MovieResponse getRemoteSelectedMovie(String id) {
        ArrayList<MovieResponse> movies = generateRemoteDummyMovies();
    ...
    public static MovieEntity getSelectedTvShows(String id) {
        ArrayList<MovieEntity> tvShows = generateDummyTvShows();
        MovieEntity selectedTvShows = null;
        for (MovieEntity tvShow : tvShows) {
    ...
    public static MovieResponse getRemoteSelectedTvShows(String id) {
        ArrayList<MovieResponse> tvShows = generateRemoteDummyTvShows();
    ...
    public static ArrayList<MovieEntity> generateDummyTvShows() {
        ArrayList<MovieEntity> tvShows = new ArrayList<>();

        MovieEntity tv1 = new MovieEntity(
                "1",
                "tv",
                "Death Note",
        ...
        MovieEntity tv2 = new MovieEntity(
                "2",
                "tv",
        ...
        MovieEntity tv3 = new MovieEntity(
                "3",
                "tv",
                "Steins;Gate",
        ...
        MovieEntity tv4 = new MovieEntity(
                "4",
                "tv",
                "Psycho-Pass",
        ...
        MovieEntity tv5 = new MovieEntity(
                "5",
                "tv",
                "Parasyte -the maxim-",
        ...
        MovieEntity tv6 = new MovieEntity(
                "6",
                "tv",
                "ERASED",
        ...
        MovieEntity tv7 = new MovieEntity(
                "7",
                "tv",
                "Terror in Resonance",
        ...
        MovieEntity tv8 = new MovieEntity(
                "8",
                "tv",
                "Noragami",
        ...
        MovieEntity tv9 = new MovieEntity(
                "9",
                "tv",
        ...
        MovieEntity tv10 = new MovieEntity(
                "10",
                "tv",
                "Blue Exorcist",
    ...
    public static ArrayList<MovieResponse> generateRemoteDummyTvShows() {
        ArrayList<MovieResponse> tvShows = new ArrayList<>();
